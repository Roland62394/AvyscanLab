...
public interface IDialogService
{
    ...
    Task ShowPresetDialogAsync(Window owner, IPresetService presets, ConfigStore config, Func<string, Dictionary<string, string>, bool, Task> applyCallback, MainWindowViewModel vm);
