...
public interface IDialogService
{
    ...
    Task<(string Name, Dictionary<string, string> Values, bool ApplyToAll)?> ShowPresetDialogAsync(Window owner, IPresetService presets, ConfigStore config, MainWindowViewModel vm, string? activePresetName = null);
